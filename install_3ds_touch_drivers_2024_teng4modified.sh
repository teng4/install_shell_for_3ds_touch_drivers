...
#curl URL-LINK-FOR-DOWNLOADING-DRIVER-2024 --output tmp/TouchDriver_2024_09_19.tgz
#echo "(note: you may need to check the driver.2024 link and set it here for curl)"
...
sudo cp TouchDriver_2024_09_19/bin/Touch* /usr/bin
echo "--- (1) installed into /usr/bin"
ls TouchDriver_2024_09_19/bin

#sudo copy all the files named "libPhantomIOLib42.so" into /usr/bin
sudo cp TouchDriver_2024_09_19/usr/lib/libPhantomIOLib42.so /usr/lib
sudo cp TouchDriver_2024_09_19/usr/lib/libPhantomManagerLite.so /usr/lib/libPhantomManagerLite.so
echo "--- (2) installed into /usr/lib"
ls TouchDriver_2024_09_19/usr/lib
...
ls TouchDriver_2024_09_19/rules.d
